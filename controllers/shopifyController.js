...
class ShopifyController {
  ...
  async authCallback(req, res) {
    ...
    // add webhook for user
      try {
        await fullPlatform.registerWebhook({
          topic: "orders/create",
        ...
        console.error("فشل تسجيل Webhook:", err.response?.data || err.message);
      }

      res.json({
        message: "تم ربط المتجر وتسجيل Webhook بنجاح",
